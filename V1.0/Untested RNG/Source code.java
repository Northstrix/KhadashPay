...
public class MainClass {
    ...
    public static void gen_keys() {
		...
		int num_of_chars_in_hk = 212 + sk0hk.nextInt(100);
		...
		disp_rec("uint8_t second_key[32] = {\n");
		for (int i = 0; i < 8; i++) {
			SecureRandom sk5 = new SecureRandom();
			for (int j = 0; j < 4; j++) {
				m = sk5.nextInt(2);
				m1 = sk5.nextInt(2);
				disp_rec("0x");
				...
				if (m == 0)
					str5.append((char)(97 + (sk5.nextInt(6))));
				if (m == 1)
					str5.append((char)(48 + (sk5.nextInt(10))));
				if (m1 == 0)
					str5.append((char)(97 + (sk5.nextInt(6))));
				if (m1 == 1)
					str5.append((char)(48 + (sk5.nextInt(10))));
				str5.append(",");
				if (i == 7 && j == 3)
					str5.setLength(str5.length() - 1);
				disp_rec(str5.toString());
			}
			disp_rec("\n");
		}
		disp_rec("};");
